...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-cli-core-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6234&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-cli-core-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-cli-core` can be installed with:

```
conda install azure-cli-core
```

It is possible to list all of the versions of `azure-cli-core` available on your platform with:
